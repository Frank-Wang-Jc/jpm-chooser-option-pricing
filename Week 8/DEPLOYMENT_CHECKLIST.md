...
- [x] Verify public, signed-out access to the GitHub repository and README
...
The publication repository is public. Learning and Understanding documents,
Word files, presentation working files and the video are not published there.
